...
const postReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case PostsActionTypes.FETCH_RELATED_POSTS_START:
      return {
        ...state,
        isFetching: true,
      };
    case PostsActionTypes.FETCH_RELATED_POSTS_SUCCESS:
      return {
        ...state,
        isFetching: false,
        related: action.payload,
      };
    case PostsActionTypes.FETCH_RELATED_POSTS_FAILURE:
      return {
        ...state,
        isFetching: false,
        errorMessage: action.payload,
    ...
    case PostsActionTypes.FETCH_POST_START:
      return {
        ...state,
        isFetching: true,
      };
